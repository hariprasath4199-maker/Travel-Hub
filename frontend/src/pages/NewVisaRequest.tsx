...
import {
  ...
  FileText, Building2, MessageSquare, Send, Loader2,
} from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const payload = {
        ...
        travelLocation: formData.destinationCountry,
  ...
  return (
    <div className="p-10 max-w-4xl mx-auto space-y-8">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h2 className="text-3xl font-extrabold tracking-tight font-headline text-on-surface">
            New Visa Request
          </h2>
          <p className="text-on-surface-variant font-body mt-1">
            Submit a visa request to HR for processing
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="bg-surface-container-lowest p-8 rounded-3xl shadow-sm space-y-6">
          <h3 className="text-xl font-bold font-headline border-b border-surface-container pb-4">
            Applicant Information
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <input
                required name="applicantName" value={formData.applicantName} onChange={handleChange}
                type="text" placeholder="e.g. Anna Korhonen" className={inputCls}
              />
            </div>
            <div className="space-y-2">
              <label className={labelCls}><Mail size={16} /> Email</label>
              <input
                required name="applicantEmail" value={formData.applicantEmail} onChange={handleChange}
                type="email" placeholder="e.g. anna.korhonen@company.fi" className={inputCls}
              />
            </div>
            <div className="space-y-2">
              <label className={labelCls}><CreditCard size={16} /> Passport Number</label>
              <input
                required name="passportNumber" value={formData.passportNumber} onChange={handleChange}
                type="text" placeholder="e.g. FI1234567" className={inputCls}
              />
            </div>
            <div className="space-y-2">
              <label className={labelCls}><FileText size={16} /> Visa Type</label>
              <select
                required name="visaType" value={formData.visaType} onChange={handleChange}
        ...
        <div className="bg-surface-container-lowest p-8 rounded-3xl shadow-sm space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <input
                required name="destinationCountry" value={formData.destinationCountry} onChange={handleChange}
                type="text" placeholder="e.g. Germany" className={inputCls}
              />
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <input
                required name="travelDateFrom" value={formData.travelDateFrom} onChange={handleChange}
            ...
            <div className="space-y-2">
              ...
              <input
                required name="travelDateTo" value={formData.travelDateTo} onChange={handleChange}
                type="date" className={inputCls}
              />
            </div>
          </div>
          <div className="space-y-2">
            ...
            <textarea
              ...
              placeholder="Describe the purpose of this visa request..."
        ...
        <div className="bg-surface-container-lowest p-8 rounded-3xl shadow-sm space-y-6">
          <h3 className="text-xl font-bold font-headline border-b border-surface-container pb-4">
            Cost Centre & Manager Notes
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <label className={labelCls}><Building2 size={16} /> Cost Centre</label>
              <input
                required name="costCentre" value={formData.costCentre} onChange={handleChange}
                type="text" placeholder="e.g. CC-FIN-001" className={inputCls}
              />
            </div>
            <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <textarea
              name="managerComments" value={formData.managerComments} onChange={handleChange} rows={3}
          ...
          <FileUpload
            ...
            onUploadComplete={(filename) => setFormData((prev) => ({ ...prev, recommendationLetterFile: filename }))}
          />
        </div>
        ...
        <div className="flex justify-end gap-4">
          ...
          <button
            ...
            className="px-8 py-3 bg-primary text-on-primary rounded-xl font-bold shadow-lg shadow-primary/20 hover:bg-primary-dim transition-all active:scale-95 disabled:opacity-70 flex items-center gap-2"
          >
            {isSubmitting ? (
              <><Loader2 size={18} className="animate-spin" /> Submitting...</>
            ) : (
              <><Send size={18} /> Submit to HR</>
            )}
          </button>
        </div>
      </form>
